"""
YouTube Automation - Simplified Main Entry Point
...
try:
    ...
    from src.downloader_robust   import VideoDownloader
...
class YouTubeAutomation:
        ...
        try:
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                if not duration or duration == 0:
                    print(f"   No duration in metadata")
                    return 0
            ...
            if 'bot' in err.lower() or 'Sign in' in err:
                print(f"   Bot detection - using default duration")
    ...
    def process_video(self, video_info):
        ...
        if duration == 0:
            print(f"No duration - using default (4 hours)")
            duration = 4 * 60 * 60
