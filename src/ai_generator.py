...
class AIGenerator:
    ...
    def generate_metadata(self, original_title, part_num=1, total_parts=1):
        """Generate unique SEO title and description"""

        if not self.api_key:
            print("   ⚠️ No OpenRouter API key — using default title")
...
- Include timestamps if multi-part
- Include relevant hashtags
- Mention Heavy Rain Deep Sleep
...
"""
    ...
    def _default_metadata(
        ...
        templates = [
            "🌧️ Heavy Rain Deep Sleep | {hours} Hours | Part {part}",
        ...
        desc = f"""🌧️ Heavy Rain Deep Sleep - Part {part_num} of {total_parts}
